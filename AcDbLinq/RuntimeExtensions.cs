...
namespace Autodesk.AutoCAD.Runtime
{
   ...
   public static partial class RuntimeExtensions
   {
      ...
      /// E.g.:
      /// 
      ///    ErrorStatus.WrongObjectType.Requires<Circle>(id);
      ///    
      /// throws an exception if the ObjectId does not represent
      /// an object that is a circle or a type derived from it.
      ///    
      ...
      /// optional arguments cannot be used in Linq expressions:
