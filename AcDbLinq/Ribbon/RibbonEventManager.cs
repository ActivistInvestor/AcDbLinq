...
namespace Autodesk.AutoCAD.Ribbon.Extensions
{
   ...
   public static class RibbonEventManager
   {
      ...
      static readonly EditorInput.Extensions.EditorStateView stateObserver = EditorInput.Extensions.EditorStateView.Instance;
      ...
      {
         AcConsole.WriteLine("RibbonEventManager.IsQuiescentChanged()");
