...
namespace Autodesk.AutoCAD.DatabaseServices.Extensions
{
   ...
   public static partial class EntityExtensions
   {
      ...
      /// <summary>
      /// Explode all entities in the sequence and adds
      ...
      /// <summary>
      /// Attempts to explode all entities in the sequence 
      /// and adds the resulting objects to DBObjectCollection
      /// pass as the output argument.
      /// 
      /// </summary>
      /// <param name="entities">The input sequence of
      /// entities to be exploded.</param>
